...
All the environments are registered in the `IsaacLabILEnvs` extension. They start
...
import IsaacLabILEnvs.tasks  # noqa: F401


def main():
    """Print all environments registered in `IsaacLabILEnvs` extension."""
